...
const SubCategoryInsights: React.FC<Props> = ({ site, data }) => {
...
Analyze the following sub-category service request data at Site ${site}:
...

{
  ...
  "most_frequent": "Name the sub-category with the highest count and what this might indicate.",
...
- Do not explain your response. Just return the JSON object.
            ...
            try {
                ...
                if (content) {
                    try {
                        ...
                        console.log('✅ SubCategory Insights Parsed:', parsed)
    ...
    return (
        <div style={styles.card}>
            <h3 style={styles.title}>📊 AI-Generated Insights: SubCategory Breakdown</h3>
            ...
            {parsedData ? (
                <>
                    ...
                    <div style={styles.section}>
                        <h4 style={styles.sectionTitle}>Most Frequent SubCategory</h4>
                ...
                <p style={styles.loading}>Analyzing sub-category trends...</p>
            )}
        </div>
    )
}
...
export default SubCategoryInsights
